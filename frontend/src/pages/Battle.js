  ...
  const battleTypes = [
    {
      ...
      winner: battleData.winner ? {
        ...
        avatar: `https://api.dicebear.com/7.x/initials/svg?seed=${battleData.winner.name}`,
        result: "Victory",
      } : null,
                ...
                {battleType.title === "Previous Battle: Daily Champion" && showResults && (
                  battleType.winner ? (
                    ...
                    >
                      ...
                      />
                      <div>
                        <p className="text-[10px] font-black text-green-500 uppercase tracking-[0.3em] mb-1">Season Winner</p>
                        <h3 className="text-3xl font-black text-gray-900 dark:text-white uppercase">{battleType.winner.name}</h3>
                        <p className="text-gray-500 dark:text-gray-400 text-sm font-bold mt-1 tracking-tight">Winner - {battleType.winner.result}</p>
                      </div>
                    </motion.div>
                  ) : (
                    ...
                    <motion.button
                      ...
                      onClick={() => {
                        if (battleType.buttonText === "Learn More") {
                          ...
                          if (!isAuthenticated) {
                            toast.error("Sign in to start scouting!");
                            navigate("/login");
                            return;
                          }
                          navigate('/ratings');
        ...
        {showModal && selectedBattle && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="text-3xl font-black mb-10 text-gray-900 dark:text-white uppercase pt-4 tracking-tighter">Event Details</h2>
